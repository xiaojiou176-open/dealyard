...
from dealyard.api.deps import get_product_service, prepare_product_runtime
from dealyard.builder_contract import list_client_ids
from dealyard.core.models import RunStats
from dealyard.core.pipeline import MonitoringPipeline
from dealyard.infra.config import load_enabled_stores_from_yaml, settings
from dealyard.infra.browser_debug import diagnose_browser_debug, probe_browser_debug, write_browser_support_bundle
...
from dealyard.persistence.session import session_scope
from dealyard.server import main as server_main
from dealyard.stores import STORE_REGISTRY
from dealyard.worker.main import main as worker_main, run_once as worker_run_once
...
def _print_main_help(stream: object) -> None:
    print("Usage: python -m dealyard <command> [...].", file=stream)
    print("", file=stream)
