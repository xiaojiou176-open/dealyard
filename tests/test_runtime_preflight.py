...
def test_validate_runtime_accepts_complete_render_payload() -> None:
    payload = {
        "DATABASE_URL": "postgresql+psycopg://user:pass@db.example.invalid/dealwatcherer",
        "OWNER_EMAIL": "alerts@example.com",
        "OWNER_BOOTSTRAP_TOKEN": "super-secret-token",
        "APP_BASE_URL": "https://dealwatcherer-api.onrender.com",
        "WEBUI_DEV_URL": "https://dealwatcherer-webui.onrender.com",
        "ZIP_CODE": "98004",
...
def test_validate_runtime_rejects_placeholders() -> None:
    payload = {
        ...
        "ZIP_CODE": "00000",
        "POSTMARK_FROM_EMAIL": "dealwatcherer@example.com",
...
def test_validate_runtime_accepts_ci_smoke_payload() -> None:
    payload = {
        "DATABASE_URL": "postgresql+psycopg://dealwatcherer:dealwatcherer@127.0.0.1:15432/dealwatcherer",
        "OWNER_EMAIL": "owner@example.com",
...
def test_validate_runtime_warns_on_legacy_path_drift() -> None:
    payload = {
        ...
        "CACHE_BUDGET_BYTES": "4294967296",
        "USE_LLM": "false",
        "DB_PATH": ".runtime-cache/cache/data/dealwatcherer.db",
...
def test_validate_runtime_rejects_legacy_shared_chrome_root_for_dealwatcherer() -> None:
    payload = {
        "DATABASE_URL": "postgresql+psycopg://dealwatcherer:dealwatcherer@127.0.0.1:15432/dealwatcherer",
        "OWNER_EMAIL": "owner@example.com",
        "OWNER_BOOTSTRAP_TOKEN": "change-me",
...
def test_validate_runtime_accepts_dedicated_chrome_root_contract() -> None:
    payload = {
        ...
        "CACHE_BUDGET_BYTES": "4294967296",
        "USE_LLM": "false",
        "CHROME_USER_DATA_DIR": "~/.cache/dealwatcherer/browser/chrome-user-data",
        "CHROME_PROFILE_NAME": "dealwatcherer",
        "CHROME_PROFILE_DIRECTORY": "Profile 21",
    }
