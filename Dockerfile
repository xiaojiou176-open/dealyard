...
RUN useradd --create-home --home-dir /home/dealwatcherer --shell /usr/sbin/nologin dealwatcherer \
    && chown -R dealwatcherer:dealwatcherer /app

USER dealwatcherer

CMD ["python", "-m", "dealwatcherer", "server"]
