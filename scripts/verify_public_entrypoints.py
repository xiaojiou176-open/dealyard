...
REQUIRED_SNIPPETS = {
    README: [
        "## Start Here",
        "https://xiaojiou176-open.github.io/dealwatcherer/compare-preview.html#sample-compare-demo",
        ...
        "Specialist route: [Builder Route](https://xiaojiou176-open.github.io/dealwatcherer/builders.html)",
        ...
        "https://github.com/xiaojiou176-open/dealwatcherer/releases/latest",
    ],
    SITE_INDEX: [
    ...
    SITE_BUILDERS: [
        "https://github.com/xiaojiou176-open/dealwatcherer/blob/main/docs/roadmaps/dealwatcherer-api-mcp-substrate-phase1.md",
        ...
        "https://github.com/xiaojiou176-open/dealwatcherer/tree/main/docs/integrations",
    ],
    SITE_COMMUNITY: [
        "https://github.com/xiaojiou176-open/dealwatcherer#start-here",
        "https://github.com/xiaojiou176-open/dealwatcherer#roadmap",
    ],
    SITE_LLMS: [
        "https://xiaojiou176-open.github.io/dealwatcherer/builders.html",
        "https://xiaojiou176-open.github.io/dealwatcherer/data/builder-client-catalog.json",
        "https://xiaojiou176-open.github.io/dealwatcherer/data/builder-client-starters.json",
        "https://xiaojiou176-open.github.io/dealwatcherer/data/builder-starter-pack.json",
        "https://xiaojiou176-open.github.io/dealwatcherer/data/builder-client-configs.json",
        "https://github.com/xiaojiou176-open/dealwatcherer/releases/latest",
        "https://github.com/xiaojiou176-open/dealwatcherer#start-here",
        "https://github.com/xiaojiou176-open/dealwatcherer#roadmap",
    ],
    SITE_FEED: [
        "https://github.com/xiaojiou176-open/dealwatcherer/releases/latest",
        "https://github.com/xiaojiou176-open/dealwatcherer/releases",
        "https://github.com/xiaojiou176-open/dealwatcherer/blob/main/CHANGELOG.md",
    ],
}

FORBIDDEN_RELEASE_TAG_PATTERNS = (
    "https://github.com/xiaojiou176-open/dealwatcherer/releases/tag/v",
    "/releases/tag/v",
)
...
def _assert_readme_start_here_order(text: str, findings: list[str]) -> None:
    try:
        ...
        compare_preview = text.index("https://xiaojiou176-open.github.io/dealwatcherer/compare-preview.html#sample-compare-demo", start_here)
        quick_start = text.index("https://xiaojiou176-open.github.io/dealwatcherer/quick-start.html", start_here)
        builders = text.index("https://xiaojiou176-open.github.io/dealwatcherer/builders.html", start_here)
