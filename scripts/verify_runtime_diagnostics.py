...
FORBIDDEN_SNIPPETS = {
    ROOT / "src" / "dealwatcherer" / "application" / "services.py": [
...
ALLOWED_PRINT_FILES = {
    ROOT / "src" / "dealwatcherer" / "cli.py",
    ROOT / "src" / "dealwatcherer" / "mcp" / "server.py",
    ROOT / "src" / "dealwatcherer" / "runtime_preflight.py",
    ROOT / "src" / "dealwatcherer" / "stores" / "base_adapter.py",
}
