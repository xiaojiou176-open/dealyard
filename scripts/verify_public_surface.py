...
ALLOWED_TRACKED_MARKDOWN = {
    ...
    "docs/roadmaps/dealyard-api-mcp-substrate-phase1.md",
    "docs/roadmaps/dealyard-decision-memo.md",
    "plugins/dealyard-builder-pack/README.md",
    "plugins/dealyard-builder-pack/skills/dealyard-readonly-builder/SKILL.md",
    "public-skills/README.md",
    "public-skills/dealyard-readonly-builder/README.md",
    "public-skills/dealyard-readonly-builder/SKILL.md",
    "public-skills/dealyard-readonly-builder/references/mcp-install.md",
    "public-skills/dealyard-readonly-builder/references/tool-map.md",
    "public-skills/dealyard-readonly-builder/references/example-tasks.md",
