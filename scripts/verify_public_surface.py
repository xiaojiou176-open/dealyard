...
ALLOWED_TRACKED_MARKDOWN = {
    ...
    "docs/roadmaps/dealwatcherer-api-mcp-substrate-phase1.md",
    "docs/roadmaps/dealwatcherer-decision-memo.md",
    "plugins/dealwatcherer-builder-pack/README.md",
    "plugins/dealwatcherer-builder-pack/skills/dealwatcherer-readonly-builder/SKILL.md",
    "public-skills/README.md",
    "public-skills/dealwatcherer-readonly-builder/README.md",
    "public-skills/dealwatcherer-readonly-builder/SKILL.md",
    "public-skills/dealwatcherer-readonly-builder/references/mcp-install.md",
    "public-skills/dealwatcherer-readonly-builder/references/tool-map.md",
    "public-skills/dealwatcherer-readonly-builder/references/example-tasks.md",
